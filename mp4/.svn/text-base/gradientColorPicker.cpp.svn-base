...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	if(d<=r)
	{
	c.red = color1.red - (d*color1.red/r) + (d*color2.red/r);
	c.green = color1.green - (d*color1.green/r) + (d*color2.green/r);
	c.blue = color1.blue - (d*color1.blue/r) + (d*color2.blue/r);
